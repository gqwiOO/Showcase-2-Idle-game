...
namespace Zenject
{
    public abstract class Context : MonoBehaviour
    {
        ...
        [ContextMenu("Set MonoInstaller With Children")]
        private void SetMonoInstallerWithChildren()
        {
            _monoInstallers = GetComponentsInChildren<MonoInstaller>().ToList();
        }
...
//#endif
    ...
    internal class NaughtyAttributes
    {
    }
}
