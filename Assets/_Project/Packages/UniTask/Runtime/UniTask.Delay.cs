...
namespace Cysharp.Threading.Tasks
{
    ...
    public partial struct UniTask
    {
        ...
        public static UniTask DelaySeconds(float secondsDelay, bool ignoreTimeScale = false, PlayerLoopTiming delayTiming = PlayerLoopTiming.Update, CancellationToken cancellationToken = default(CancellationToken))
        {
