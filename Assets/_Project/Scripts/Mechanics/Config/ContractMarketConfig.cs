...
namespace Mechanics.Config
{
    ...
    {
        [Header("Offers")]
        [SerializeField] private IntProperty _offersPerNight = IntProperty.Constant(6);
        ...
        [SerializeField] private IntProperty _requiredRolesCount = IntProperty.RandomBetween(1, 4);
        ...
        public int OffersPerNight => _offersPerNight.Value;
        ...
        public int RequiredRolesCount => _requiredRolesCount.Value;
